...
public:
	...
	virtual void		SwitchToLoop( const char *pszMode, KeyValues *, uint32 nId, const char *, bool ) = 0;
	...
	virtual void		*GetEngineWindowInfo( void ) const = 0;
	virtual int64		GetEngineWindowWidth( void ) const = 0;
	virtual int64		GetEngineWindowHeight( void ) const = 0;
