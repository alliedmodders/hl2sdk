...
int32_t ThreadInterlockedIncrement( int32_t volatile * pDest )                                         { Assert( (size_t)pDest % 4 == 0 ); return __atomic_add_fetch( pDest, 1, __ATOMIC_ACQ_REL ); }
int32_t ThreadInterlockedDecrement( int32_t volatile * pDest )                                         { Assert( (size_t)pDest % 4 == 0 ); return __atomic_sub_fetch( pDest, 1, __ATOMIC_ACQ_REL ); }
int32_t ThreadInterlockedExchange( int32_t volatile * pDest, int32_t value )                           { Assert( (size_t)pDest % 4 == 0 ); return __atomic_exchange_n( pDest, value, __ATOMIC_ACQ_REL ); }
int32_t ThreadInterlockedExchangeAdd( int32_t volatile * pDest, int32_t value )                        { Assert( (size_t)pDest % 4 == 0 ); return __atomic_fetch_add( pDest, value, __ATOMIC_ACQ_REL ); }
...
bool ThreadInterlockedAssignIf( int32_t volatile * pDest, int32_t value, int32_t comperand )           { Assert( (size_t)pDest % 4 == 0 ); return __atomic_compare_exchange_n( pDest, &comperand, value, false, __ATOMIC_ACQ_REL, __ATOMIC_RELAXED ); }
