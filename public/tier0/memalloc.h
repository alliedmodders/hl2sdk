...
#define MEMALLOC_DEFINE_EXTERNAL_TRACKING( tag ) \
	static CUtlOrderedMap<void *, MemAllocFileLine_t, int> s_##tag##Allocs( DefLessFunc( void *) ); \
	CUtlOrderedMap<void *, MemAllocFileLine_t, int> * g_p##tag##Allocs = &s_##tag##Allocs; \
...
#define MEMALLOC_DECLARE_EXTERNAL_TRACKING( tag ) \
	extern CUtlOrderedMap<void *, MemAllocFileLine_t, int> * g_p##tag##Allocs; \
...
#define MemAlloc_RegisterExternalDeallocation( tag, p, size ) \
	...
	{ \
		MemAllocFileLine_t fileLine = { g_psz##tag##Alloc, 0 }; \
		CUtlOrderedMap<void *, MemAllocFileLine_t, int>::IndexType_t iRecordedFileLine = g_p##tag##Allocs->Find( p ); \
