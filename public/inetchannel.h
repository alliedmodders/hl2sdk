...
public:
	...
	virtual int		SendMessages(const char* pDebugName, bf_write* data) = 0;		//40 //Basically thread-safe version of CNetChan::TransmitInternal
	...
	virtual void	sub_180097DA0_SetUnknown(void *pUnknownStruct) = 0;				//57		//idk, can this be SetRemoteFramerate?
