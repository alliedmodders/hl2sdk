...
public:
	...
	CUtlVectorBase( int growSize = 0, int initSize = 0 );
	CUtlVectorBase( T* pMemory, int allocationCount, int numElements = 0 );
	~CUtlVectorBase();
	...
	int AddVectorToTail( CUtlVectorBase<T, I, A> const &src );
...
public:
	CUtlBlockVector( int growSize = 0, int initSize = 0 )
		: CUtlVectorBase< T, I, CUtlBlockMemory< T, I > >( growSize, initSize ) {}
};
...
inline CUtlVectorBase<T, I, A>::CUtlVectorBase( int growSize, int initSize ) : 
	m_Size(0), m_Memory(growSize, initSize)
{
}

template< typename T, class I, class A >
inline CUtlVectorBase<T, I, A>::CUtlVectorBase( T* pMemory, int allocationCount, int numElements )	: 
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline T& CUtlVectorBase<T, I, A>::operator[]( int i )
{
	Assert( i < m_Size );
	return m_Memory[ i ];
}
...
template< typename T, class I, class A >
inline const T& CUtlVectorBase<T, I, A>::operator[]( int i ) const
{
	Assert( i < m_Size );
	return m_Memory[ i ];
}
...
template< typename T, class I, class A >
inline T& CUtlVectorBase<T, I, A>::Element( int i )
{
	Assert( i < m_Size );
	return m_Memory[ i ];
}
...
template< typename T, class I, class A >
inline const T& CUtlVectorBase<T, I, A>::Element( int i ) const
{
	Assert( i < m_Size );
	return m_Memory[ i ];
}
...
inline void CUtlVectorBase<T, I, A>::SetExternalBuffer( T *pMemory, int allocationCount, int numElements )
{
...
template< class T, class I, class A >
void CUtlVectorBase<T, I, A>::SetExternalBuffer( const T *pMemory, int allocationCount, int numElements )
{
	m_Memory.SetExternalBuffer( pMemory, allocationCount );
	m_Size = numElements;
}
...
template< class T, class I, class A >
inline void CUtlVectorBase<T, I, A>::AssumeMemory( T *pMemory, int allocationCount, int numElements )
{
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::Count() const
{
	return m_Size;
}
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline bool CUtlVectorBase<T, I, A>::IsValidIndex( int i ) const
{
	return (i >= 0) && (i < m_Size);
}
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::InvalidIndex()
{
	return -1;
}
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::GrowVector( int num )
{
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::EnsureCapacity( int num )
{
	MEM_ALLOC_CREDIT_CLASS();
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::EnsureCount( int num )
{
	if (Count() < num)
	{
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::ShiftElementsRight( int elem, int num )
{
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::ShiftElementsLeft( int elem, int num )
{
	Assert( IsValidIndex(elem) || ( m_Size == 0 ) || ( num == 0 ));
	int numToMove = m_Size - elem - num;
	if ((numToMove > 0) && (num > 0))
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddToHead()
{
	return InsertBefore(0);
}

template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddToTail()
{
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::InsertAfter( int elem )
{
	return InsertBefore( elem + 1 );
}

template< typename T, class I, class A >
int CUtlVectorBase<T, I, A>::InsertBefore( int elem )
{
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddToHead( const T& src )
{
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddToTail( const T& src )
{
	// Can't insert something that's in the list... reallocation may hose us
	Assert( (Base() == NULL) || (&src < Base()) || (&src >= (Base() + Count()) ) ); 
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::InsertAfter( int elem, const T& src )
{
	// Can't insert something that's in the list... reallocation may hose us
	Assert( (Base() == NULL) || (&src < Base()) || (&src >= (Base() + Count()) ) ); 
...
template< typename T, class I, class A >
int CUtlVectorBase<T, I, A>::InsertBefore( int elem, const T& src )
{
	// Can't insert something that's in the list... reallocation may hose us
	Assert( (Base() == NULL) || (&src < Base()) || (&src >= (Base() + Count()) ) ); 
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddMultipleToHead( int num )
{
	return InsertMultipleBefore( 0, num );
}

template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddMultipleToTail( int num )
{
	return InsertMultipleBefore( m_Size, num );
}

template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::AddMultipleToTail( int num, const T *pToCopy )
{
	// Can't insert something that's in the list... reallocation may hose us
...
template< typename T, class I, class A >
int CUtlVectorBase<T, I, A>::InsertMultipleAfter( int elem, int num )
{
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::SetCount( int count )
{
	RemoveAll();
...
template< typename T, class I, class A >
inline void CUtlVectorBase<T, I, A>::SetSize( int size )
{
	SetCount( size );
}

template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::SetCountNonDestructively( int count )
{
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::CopyArray( const T *pArray, int size )
{
	// Can't insert something that's in the list... reallocation may hose us
...
template< typename T, class I, class A >
int CUtlVectorBase<T, I, A>::AddVectorToTail( CUtlVectorBase const &src )
{
	Assert( &src != this );
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::InsertMultipleBefore( int elem, int num )
{
	if( num == 0 )
		return elem;
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::InsertMultipleBefore( int elem, int num, const T *pToInsert )
{
	if( num == 0 )
		return elem;
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
int CUtlVectorBase<T, I, A>::Find( const T& src ) const
{
...
//-----------------------------------------------------------------------------
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::FastRemove( int elem )
{
	Assert( IsValidIndex(elem) );
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::Remove( int elem )
{
	Destruct( &Element(elem) );
	ShiftElementsLeft(elem);
	--m_Size;
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::RemoveMultiple( int elem, int num )
{
	Assert( elem >= 0 );
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::RemoveMultipleFromHead( int num )
{
	Assert( num <= Count() );
...
template< typename T, class I, class A >
void CUtlVectorBase<T, I, A>::RemoveMultipleFromTail( int num )
{
	Assert( num <= Count() );
...
template< typename T, class I, class A >
inline int CUtlVectorBase<T, I, A>::NumAllocated() const
{
