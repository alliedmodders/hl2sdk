...
protected:
	...
	typedef CUtlVectorMemory<ListElem_t> M; // Keep naming similar to CUtlLinkedList
public:
...
inline bool CUtlMultiList<T,I>::IndexInRange( int index ) // Static method
{
	...
	// case CUtlVectorMemory will have 'InvalidIndex == (int)-1' (which casts to 65535 in I), and will
