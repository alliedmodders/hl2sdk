...
public:
	...
	virtual float		GetAvgLatency( void ) const = 0;	// average packet latency in seconds					// 10
	virtual float		GetEngineLatency( void ) const = 0;	// current latency (RTT), more accurate but jittering	// 11
