...
const EDotaUserMessages EDotaUserMessages_MAX = DOTA_UM_CourierKilledAlert;
...
const DOTA_CHAT_MESSAGE DOTA_CHAT_MESSAGE_MAX = CHAT_MESSAGE_COMPENDIUM_LEVEL;
...
const DOTA_COMBATLOG_TYPES DOTA_COMBATLOG_TYPES_MAX = DOTA_COMBATLOG_BUYBACK;
...
class CDOTAUserMsg_TournamentDrop : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_winner_name(::std::string* winner_name);
...
inline void CDOTAUserMsg_TournamentDrop::set_allocated_winner_name(::std::string* winner_name) {
  if (winner_name_ != &::google::protobuf::internal::kEmptyString) {
    delete winner_name_;
  }
  if (winner_name) {
